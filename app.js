...
// Map interests to suggested action cards
...
// Handle a suggestion tap — either a tab or a specific tool
...
function exportData() {
  const data = {
    goals: state.goals, decisions: state.decisions, snapshot: state.snapshot,
    currency: state.currency, interests: state.interests,
