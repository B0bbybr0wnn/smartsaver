...
async function checkAuth() {
  try {
    ...
    const res = await fetch('/auth/me', { credentials: 'same-origin', headers });
...
async function refreshFriends() {
  try {
    const res = await fetch('/api/friends/list', { credentials: 'same-origin', headers: getSessionHeader() });
    if (!res.ok) return;
    const data = await res.json();
...
async function openFriendProfile(friendId) {
  ...
  try {
    const res = await fetch('/api/friends/data?friendId=' + friendId, { credentials: 'same-origin', headers: getSessionHeader() });
    const data = await res.json();
...
async function fetchBuzzes() {
  if (!state.user) return;
  try {
    const res = await fetch('/api/buzzes', { credentials: 'same-origin', headers: getSessionHeader() });
    if (!res.ok) return;
    const data = await res.json();
...
async function cloudPullThenMaybePush() {
  ...
  try {
    const res = await fetch('/api/data', { credentials: 'same-origin', headers: getSessionHeader() });
