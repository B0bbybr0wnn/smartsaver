...
const LOCALES = {
  en: {
    ...
    username_cooldown: 'You can only change your username once every 30 days.',
    username_next_change: 'You can change again on',
    username_unchanged: 'No change',
    username_taken: 'Username taken',
    username_saved: 'Username saved',

    streak_at_risk: 'Don\'t break your streak',
    streak_lost_title: 'Your streak reset',
    streak_lost_sub: 'Start a new one today',
    streak_missed_days: 'You were away',
    streak_days: 'days',
    ...
    save_title: 'Save', save_goals_title: 'Savings goals', new_goal: 'New savings goal',
    new_goal_title: 'New goal', new_goal_sub: 'What are you saving for?',
    ...
    decide_title: 'Affordability check', item_name: 'Item or purchase name', price: 'Price',
    ...
    more_title: 'More', account_title: 'Account',
    preferences: 'Preferences', your_data: 'Your data', money_tips: 'Money tips',
...
de: {
  ...
  username_cooldown: 'Du kannst deinen Benutzernamen nur alle 30 Tage ändern.',
  username_next_change: 'Du kannst wieder ändern am',
  username_unchanged: 'Keine Änderung',
  username_taken: 'Benutzername vergeben',
  username_saved: 'Benutzername gespeichert',

  streak_at_risk: 'Brich deine Serie nicht ab',
  streak_lost_title: 'Deine Serie wurde zurückgesetzt',
  streak_lost_sub: 'Starte heute eine neue',
  streak_missed_days: 'Du warst weg',
  streak_days: 'Tage',
  ...
  save_title: 'Sparen', save_goals_title: 'Sparziele', new_goal: 'Neues Sparziel',
  new_goal_title: 'Neues Ziel', new_goal_sub: 'Wofür sparst du?',
  ...
  decide_title: 'Kaufprüfung', item_name: 'Artikel- oder Kaufname', price: 'Preis',
  ...
  more_title: 'Mehr', account_title: 'Konto',
  preferences: 'Einstellungen', your_data: 'Deine Daten', money_tips: 'Geld-Tipps',
  ...
  decisions_made: 'Entscheidungen'
    ...
    username_cooldown: 'Solo puedes cambiar tu nombre de usuario una vez cada 30 días.',
    username_next_change: 'Puedes cambiar de nuevo el',
    username_unchanged: 'Sin cambios',
    username_taken: 'Nombre de usuario en uso',
    username_saved: 'Nombre de usuario guardado',

    streak_at_risk: 'No rompas tu racha',
    streak_lost_title: 'Tu racha se reinició',
    streak_lost_sub: 'Empieza una nueva hoy',
    streak_missed_days: 'Estuviste ausente',
    streak_days: 'días',
    ...
    save_title: 'Ahorrar', save_goals_title: 'Metas de ahorro', new_goal: 'Nueva meta de ahorro',
    new_goal_title: 'Nueva meta', new_goal_sub: '¿Para qué estás ahorrando?',
    ...
    decide_title: 'Comprobación de asequibilidad', item_name: 'Nombre del artículo o compra', price: 'Precio',
    ...
    more_title: 'Más', account_title: 'Cuenta',
    preferences: 'Preferencias', your_data: 'Tus datos', money_tips: 'Consejos de dinero',
